...
<template>
  ...
  <form class="custom-form" @submit.prevent="submitHandler">
    <custom-input
      ...
      v-model:is-valid="nameInput.isValid"
      label="Name"
      name="name"
    ...
    <custom-input
      ...
      v-model:is-valid="passwordInput.isValid"
      label="Password"
      name="pwd"
    ...
    <custom-input
      ...
      v-model:is-valid="numberInput.isValid"
      label="Number"
      name="number"
  ...
  <custom-popup v-model:is-visible="isPopupVisible">
    <template v-slot="closePopup">
      ...
      <custom-heading level="4"
        >Password: {{ passwordInput.value }}</custom-heading
      >
